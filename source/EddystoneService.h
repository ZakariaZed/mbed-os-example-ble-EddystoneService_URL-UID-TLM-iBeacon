...
#include <string.h>
    ...
    #define YOTTA_CFG_EDDYSTONE_DEFAULT_URL_FRAME_INTERVAL 750
#endif
    ...
    #define YOTTA_CFG_EDDYSTONE_DEFAULT_TLM_FRAME_INTERVAL 1250
#endif

#ifndef YOTTA_CFG_EDDYSTONE_DEFAULT_IBEACON_INTERVAL
    #define YOTTA_CFG_EDDYSTONE_DEFAULT_IBEACON_INTERVAL 530
#endif
...
public:
     ...
     * Service.
     */
     void updateCharacteristicValues2(void);
    ...
    static const uint16_t DEFAULT_IBEACON_PERIOD_MSEC = YOTTA_CFG_EDDYSTONE_DEFAULT_IBEACON_INTERVAL;
    ...
    void updatetemperatureValues(uint8_t newLevel);
     void authentificationcondition( uint8_t T);
     void basicAuthorCallback (GattReadAuthCallbackParams *authParams);
    /**
    ...
    void setUIDData(const UIDNamespaceID_t &uidNamespaceIDIn, const UIDInstanceID_t &uidInstanceIDIn);
            /******************************************************************/
        void setiBeacon(uint8_t  uuid[16],
            uint16_t        majNum,
            uint16_t        minNum,
            uint8_t         txP    = 0xb3,
            uint16_t        compID = 0x0059);
        /*********************************************************************/
    ...
    void setTLMFrameAdvertisingInterval(uint16_t tlmFrameIntervalIn = DEFAULT_TLM_FRAME_PERIOD_MSEC);
      void setiBeaconAdvertisingInterval(uint16_t iBeaconIntervalIn = DEFAULT_IBEACON_PERIOD_MSEC);
    ...
    EddystoneError_t startConfigServiceafterdeconnexion(void);
    /**
...
private:
    ...
    uint16_t          tlmtemperature;
    uint8_t          Authentification;
    /**
     * The value of the Eddystone-URL Configuration Service Beacon Period
    ...
    ReadWriteGattCharacteristic<uint16_t>                           *beaconPeriodChar;
      ReadWriteGattCharacteristic<uint16_t>                           *beaconPeriodUIDChar;       
      ReadWriteGattCharacteristic<uint16_t>                           *beaconPeriodTLMChar;
        /**/
     ReadOnlyGattCharacteristic<uint16_t>                           *TEMPERATURE;
    /**
     * Pointer to the BLE API characteristic encapsulation for the Eddystone-URL
    ...
    GattCharacteristic                                              *charTable[TOTAL_CHARACTERISTICS];
        GattCharacteristic                                              *charTab[2];
        GattCharacteristic                                              *charT[1];
        GattCharacteristic                                              *charTabl[1];
