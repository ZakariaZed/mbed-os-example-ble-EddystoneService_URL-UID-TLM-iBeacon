...
const uint8_t UUID_TLM_BEACON_SERVICE[]    = UUID_URL_BEACON(0x20, 0x90);
const uint8_t UUID_UID_BEACON_SERVICE[]    = UUID_URL_BEACON(0x20, 0x92);
/**
...
const uint8_t UUID_TLMBEACON_PERIOD_CHAR[]    = UUID_URL_BEACON(0x20, 0x91);
/**
...
typedef uint8_t proximityUUID[16];
/**
